...
wget https://github.com/germanua/Linux-SoundBoard/releases/latest/download/linux-soundboard-2.4.2-linux-x86_64.tar.gz

# 2. Extract it
tar -xzf linux-soundboard-2.4.2-linux-x86_64.tar.gz
cd linux-soundboard-2.4.2-linux-x86_64
...
```bash
sudo apt install ./linux-soundboard_2.4.2-1_amd64.deb
```
...
```bash
sudo dnf install ./linux-soundboard-2.4.2-1.x86_64.rpm
```
